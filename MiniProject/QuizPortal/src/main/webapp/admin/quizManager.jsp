...
<%@ page import="com.model.Admin, com.model.Quiz, java.util.List" %>
<%
                    ...
                    for (Quiz quiz : quizzes) { %>
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="${pageContext.request.contextPath}/admin/quizManager" method="post" onsubmit="return confirm('Are you sure you want to delete this quiz?');" style="display:inline;">
