<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="com.model.Admin, com.model.Question, java.util.List"%>
<%
	...
	<div class="layout">
		<aside class="sidebar">
			...
			<a href="${pageContext.request.contextPath}/admin/dashboard"
				...
				class="menu-item active">🆕 Create Quiz</a>
		</aside>

		<main class="main-content">
			<div class="form-container">
				<h2>Create Quiz</h2>
				<form action="${pageContext.request.contextPath}/admin/createQuiz"
					method="post">
					<div class="form-group">
						<label for="quizTitle">Quiz Title</label> <input type="text"
							id="quizTitle" name="quizTitle" required>
					</div>
					<div class="form-group">
