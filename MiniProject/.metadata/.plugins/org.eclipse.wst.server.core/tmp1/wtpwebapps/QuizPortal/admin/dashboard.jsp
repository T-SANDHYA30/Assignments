...
<body>
    <div class="layout">
        <aside class="sidebar">
            ...
            <a href="${pageContext.request.contextPath}/user/home.jsp" class="logout-btn">Logout</a>
        </aside>
        <main class="main-content">
            ...
            <section class="table-container">
                ...
                <p  style="margin-top: 2px; font-weight:700; color: #151b8d;">Click "Quiz Manager" to manage Quiz.</p>
                <p  style="margin-top: 2px; font-weight:700; color: #571b7e;">Click "Question Manager" to add or delete Questions</p>
                <p   style="margin-top: 2px; font-weight:700; color: #151b8d;">Click "Add new Questions" to add new questions</p>
                <p style="margin-top: 2px; font-weight:700; color: #571b7e;">Click "Create Quiz" to add quiz by adding questions</p>
            </section>
        </main>
    </div>
</body>
