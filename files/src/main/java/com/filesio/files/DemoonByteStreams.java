...
//		writer.write("Believe in yourself");
//		writer.newLine();
//		writer.append("GO girl");
//		writer.newLine();
//		writer.write("Believe");
//		writer.close();
		
		//byte stream
//        FileOutputStream fos=new FileOutputStream("assets/info.txt");
//        String text="sandhya thummaluru";
...
//		
//		Bottle b1=new Bottle(1,"cello",200,"black");
...
//		oos.close();
		...
		ois.read();
		Bottle b2=(Bottle)ois.readObject();
		ois.close();
