package com.project.HibernateTemplateAndTransactionMangement.config;
...
@Configuration
@ComponentScan(basePackages ="com.project.HibernateTemplateAndTranscactionMangement")
...
public class AppConfig {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		factory.setAnnotatedClasses(Order.class,Payment.class);
	...
	@Bean
	public HibernateTransactionManager getTXManager(SessionFactory sf) {
